...
- Generated: 2026-09-09T07:32:44Z
...
| --- | --- | --- | --- | --- | --- |
| 10c4:ea60 CP2102N USB to UART Bridge Controller | IOUserSerial, IOSerialBSDClient | 1/1 ifaces · kIOReturnSuccess (0x0) | 1/1 ifaces · kIOReturnSuccess (0x0) | 0/0 ifaces · n/a | 1/1 ifaces · kIOReturnSuccess (0x0) |
...
- **10c4:ea60 CP2102N USB to UART Bridge Controller** — USABLE TODAY — full userspace access without any special entitlement
  - iface 0 (class 255): IOUserSerial [kernel driver] — open: kIOReturnSuccess (0x0)
...
- **10c4:ea60 CP2102N USB to UART Bridge Controller** — BLOCKED — kernel driver owns the device; requires DriverKit-level rebinding
